    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CarnagyContext>
    {
        ...
        private void AddFileds(CarnagyContext context)
        {
            var listFields = new[]
            {
                ...
                new Field {MainConfigurationId=1, ConfigurationType = FieldConfigurationType.List, Name = FiledNameConstant.Url,              Xpath = "div[1]/div[1]/div[2]/span[1]/a[1],/div/div[1]/div[2]/h2/a",Attribute = "href",IsDefault = true},
